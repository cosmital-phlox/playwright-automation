...
- Name: frontend/account.spec.js >> Logout from the account menu
- Location: tests/frontend/account.spec.js:5:1
...
Locator: locator('.navbar-item.has-dropdown.user-details')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.navbar-item.has-dropdown.user-details')

```

```yaml
- text: "Error - Request ID: 01KZ45NHM3ABWMTX471Z18TY51"
```
